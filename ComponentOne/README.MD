...
Attached to the repo [here](uControllerLab1/ComponentOne/ComponentOne/ComponentOne.ino) is a blank sketch that you can use to structure your code.  Alternatively, there is a completed Blink sketch located [here](ComponentOne/Blink/Blink.ino).
